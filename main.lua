...
SMODS.Challenge{ -- Three-Body Problem
    loc_txt = "Challenger Exmaples: Three-Body Problem",
    key = 'three_body_1',
    rules = {
        custom = {
...
SMODS.Challenge{ -- Nepo Baby
    loc_txt = "Challenger Exmaples: Nepo Baby",
    key = 'nepo_1',
    rules = {
        custom = {
...
SMODS.Challenge{ -- Double Trouble
    loc_txt = "Challenger Exmaples: Double Trouble",
    key = 'double_1',
    rules = {
        custom = {
            {id = 'second_boss'}
...
SMODS.Challenge{ -- The Pinch
    loc_txt = "Challenger Exmaples: The Pinch",
    key = 'pinch_1',
    rules = {
        custom = {
...
SMODS.Challenge{ -- Forever Howlong
    loc_txt = "Challenger Exmaples: Forever Howlong",
...
SMODS.Challenge{ -- Chaos
    loc_txt = "Challenger Exmaples: Chaos",
    key = 'chaos_1',
    rules = {
        custom = {
            {id = 'chaos_engine'}
...
SMODS.Challenge{ -- Chaos Incarnate
    loc_txt = "Challenger Exmaples: Chaos Incarnate",
    key = 'chaos_2',
    rules = {
        custom = {
            {id = 'chaos_engine_all'}
